...
const services = [
  ...
  ServiceItem(id: 4, name: 'Auto',       icon: '🛺', category: 'ride',     tag: null,        color: kOrangeLight, accent: kOrange,           bikeOnly: false),
  ServiceItem(id: 5, name: 'Toto',       icon: 'toto', category: 'ride',   tag: 'Eco',       color: kOrangeLight, accent: kOrange,           bikeOnly: false),
