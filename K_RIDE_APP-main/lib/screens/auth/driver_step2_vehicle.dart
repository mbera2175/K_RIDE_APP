...
class _DriverStep2VehicleState extends State<DriverStep2Vehicle> {
  ...
  String _vehicleType      = 'three_wheeler';
  ...
  final List<Map<String, dynamic>> _vehicles = [
    ...
    {'type': 'three_wheeler', 'icon': Icons.electric_rickshaw_rounded, 'label': 'Three Wheeler'},
              ...
              children: [
                ...
                GridView.count(
                  ...
                  children: [
                    ...
                    if (_vehicleType == 'bike' || _vehicleType == 'three_wheeler')
